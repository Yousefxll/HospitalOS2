...
export default function QuotasPage() {
  ...
  const featureKeys = [
    { value: 'policy.search', label: 'Policy Search' },
    { value: 'policy.view', label: 'Policy View' },
  ...
  return (
    <div className="space-y-6">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>{language === 'ar' ? 'الميزات (يمكن اختيار أكثر من واحد)' : 'Features (can select multiple)'}</Label>
              ...
              <div className="space-y-2">
                <Label>{language === 'ar' ? 'الحد الأقصى (اختياري)' : 'Limit (Optional)'}</Label>
                <Input
                  type="number"
                  min="1"
              ...
              <div className="space-y-2">
                <Label>{language === 'ar' ? 'تاريخ الانتهاء (اختياري)' : 'End Date (Optional)'}</Label>
                <Input
                  type="datetime-local"
      ...
      <Card>
        <CardHeader>
          <CardTitle>{language === 'ar' ? 'الحصص' : 'Quotas'}</CardTitle>
          <CardDescription>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{language === 'ar' ? 'الميزة' : 'Feature'}</TableHead>
                <TableHead>{language === 'ar' ? 'الحد الأقصى' : 'Limit'}</TableHead>
            ...
            <TableBody>
              {quotas.map((quota) => (
                <TableRow key={quota.id}>
                  ...
                  <TableCell>{quota.featureKey}</TableCell>
                  <TableCell>
