...
## Overview
The Language Toggle button is now a core component that appears on all pages of the SYRA application. It allows users to switch between Arabic (AR) and English (EN) languages.
