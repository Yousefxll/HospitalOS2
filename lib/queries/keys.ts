...
export const queryKeys = {
  ...
  opd: {
    all: ['opd'] as const,
    departments: {
      all: () => [...queryKeys.opd.all, 'departments'] as const,
      lists: () => [...queryKeys.opd.departments.all(), 'list'] as const,
      list: (filters?: Record<string, any>) => [...queryKeys.opd.departments.lists(), filters] as const,
    },
    rooms: {
      all: () => [...queryKeys.opd.all, 'rooms'] as const,
      lists: () => [...queryKeys.opd.rooms.all(), 'list'] as const,
      list: (filters?: Record<string, any>) => [...queryKeys.opd.rooms.lists(), filters] as const,
    },
    doctors: {
      all: () => [...queryKeys.opd.all, 'doctors'] as const,
      lists: () => [...queryKeys.opd.doctors.all(), 'list'] as const,
      list: (filters?: Record<string, any>) => [...queryKeys.opd.doctors.lists(), filters] as const,
      details: () => [...queryKeys.opd.doctors.all(), 'detail'] as const,
      detail: (id: string) => [...queryKeys.opd.doctors.details(), id] as const,
    },
  },
