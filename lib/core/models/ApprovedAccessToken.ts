 ...
 * 
 * Allows SYRA Owner to access tenant data temporarily with tenant admin approval.
 * - Time-limited access
...
export interface ApprovedAccessToken {
  id: string; // UUID
  ownerId: string; // SYRA Owner user ID
  ownerEmail: string; // SYRA Owner email (for display)
